...
namespace WilpSocialMedia.Message.Domain.Model
{
    public partial class Wilpsocialmedia_MessageContext : DbContext
    {
        public Wilpsocialmedia_MessageContext(DbContextOptions<Wilpsocialmedia_MessageContext> options)
            : base(options)
        {
